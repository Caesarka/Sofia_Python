...
class ModalWindow(Tk):
    def __init__(self, root):
        ...
        self.lbl_task_description = LabelFrame(
            self, text="Add task description")
        self.task_description = Text(self.lbl_task_description)

        self.btn_add_task = Button(
            self, text="Add task", command=self.create_task)
    ...
    def create_task(self):
        ...
        self.main_root.render_task(data)
        self.destroy()
